    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userlevel', models.CharField(choices=[('farmer', 'Farmer'), ('accounts', 'Accountant'), ('factory_admin', 'Factory Admin'), ('overadmin', 'Super Admin')], default='farmer', max_length=50, null=True)),
